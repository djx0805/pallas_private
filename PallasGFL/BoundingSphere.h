...
namespace pallas
{
	namespace gfl
	{
		...
		* etc. Similar in function to BoundingBoxImpl, it's quicker for evaluating
		...
		*/
		...
		{
			// ignore operation if incoming BoundingSphereImpl is invalid.
			if (!sh.valid()) return;
		...
		//
		typedef BoundingSphereImpl<float> BoundingSpheref;
		typedef BoundingSphereImpl<double> BoundingSphered;

#ifdef _USE_FLOAT_BOUNDINGSPHERE
